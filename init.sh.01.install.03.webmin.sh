...
if [[ ! -f "${WEBMINTMP}" ]]; then
  V="1.620"
  wget -O $WEBMINTMP 'http://downloads.sourceforge.net/project/webadmin/webmin/$V/webmin-$V-1.noarch.rpm?r=http%3A%2F%2Fwww.webmin.com%2Fdownload.html&ts=1365823599&use_mirror=surfnet'
